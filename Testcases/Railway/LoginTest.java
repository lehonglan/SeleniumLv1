...
public class LoginTest extends TestBase {
	...
	public void TC01() {
		...
		assertEquals(generalPage.getWelcomeMessage(), Constant.Login.welcomeMessage(Constant.Login.USERNAME));
		homePage.logOut();
	}
	...
	public void TC04() {
		...
		assertEquals(generalPage.getCurrentTitle(), pageTitle.LOGIN.getValue());
		homePage.logOut();
	}
	...
	public void TC06() {
		...
		softAssertion.assertEquals(generalPage.getCurrentTitle(), pageTitle.MYTICKET.getValue());

		homePage.openTab(tabName.CHANGEPASSWORD);
		softAssertion.assertEquals(generalPage.getCurrentTitle(), pageTitle.CHANGEPASSWORD.getValue());
